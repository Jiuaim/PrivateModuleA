...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PrivateModuleA.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hsz/PrivateModuleA'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hsz' => 'shengzhong.huang@zhengmen.com' }
  s.source           = { :git => 'https://github.com/hsz/PrivateModuleA.git', :tag => s.version.to_s }
